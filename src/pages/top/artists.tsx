				...
				<div>
					{topTracks.data ? (
						topTracks.data.items.map((artist, index) => (
							<div
								className='grid grid-cols-[1.25rem_1fr] items-center gap-4 rounded-[4px] px-4 py-2 md:hover:bg-black md:hover:bg-opacity-10 dark:md:hover:bg-white dark:md:hover:bg-opacity-10'
								key={artist.id}
							>
